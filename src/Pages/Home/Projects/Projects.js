                ...
                <div className="card lg:max-w-lg bg-base-100 shadow-xl lg:mx-5 mb-12">
                    <div className="card-body justify-center items-center">
                        ...
                        <div className="card-actions">
                            <a className="btn mt-3 text-black  bg-orange-500 hover:bg-white bg-white transition duration-700" href='https://robotics-parts-manufacturer.web.app/' target='_blank'>Preview</a>
                        </div>
                    </div>
                </div>
                <div className="card lg:max-w-lg bg-base-100 shadow-xl lg:mx-5 mb-12">
                    <div className="card-body justify-center items-center">
                        ...
                        <div className="card-actions">
                            <a className="btn mt-3 text-black  bg-orange-500 hover:bg-white bg-white transition duration-700" href='https://sports-mans-warehouse.web.app/' target='_blank'>Preview</a>
                        </div>
                    </div>
                </div>
                <div className="card lg:max-w-lg bg-base-100 shadow-xl lg:mx-5 mb-12">
                    <div className="card-body justify-center items-center">
                        ...
                        <div className="card-actions">
                            <a className="btn mt-3 text-black  bg-orange-500 hover:bg-white bg-white transition duration-700" href='https://one-studio-e6f0f.web.app/' target='_blank'>Preview</a>
                        </div>
                    </div>
                </div>
            </div>
